 ...
 */
//#endregion
router.post("/:id", auth, checkSchema(validations.update), schemaErrorHandler(), controllerAdapter(branchControllerInstance, 'update'))
 ...
 */
//#endregion
router.post("/:id", auth, controllerAdapter(branchControllerInstance, 'delete'))
