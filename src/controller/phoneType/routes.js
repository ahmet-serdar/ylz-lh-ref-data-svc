 ...
 */
//#endregion
router.post("/:id", auth, checkSchema(validations.update), schemaErrorHandler(), controllerAdapter(phoneTypeControllerInstance, 'update'))
 ...
 */
//#endregion
router.post("/:id", auth, controllerAdapter(phoneTypeControllerInstance, 'delete'))
